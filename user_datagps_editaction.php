			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				if($ukuran < 1044070){			
					...
					if($query){
						...
						//echo $nama;
						header("location:user_datagps_edit.php?id=$id&pesan=gagal");
					}
				}else{
					header("location:user_datagps_edit.php?id=$id&pesan=besar");
				}
			}else{
				header("location:user_datagps_edit.php?id=$id&pesan=salah");
			}	
	}
	else{

		...
		<div id="login" class="container mt-2">
			<div class="container mt-5">
				<div class="card bg-light" style="max-width: 25 rem; margin: 0 auto; float: none;">
					...
					<form method="post" action="admin_datagps_tambahaction.php" enctype="multipart/form-data">
						<div class="card-body"> 
							<div class="form-group col-5">
								<label for="brand">Brand</label>
								<input type="text" class="form-control" name="brand" id="brand" placeholder="GPS Brand">
							</div>
							<div class="form-group col-5">
								<label for="model">Model</label>
								<input type="text" class="form-control" name="model" id="model" placeholder="GPS Model">
							</div>
							<div class="form-group col-5">
							...
							<div class="form-group col-5">
								...
								<input type="text" class="form-control datepicker" name="buy_date" id="datepicker" placeholder="Buy Date">
								</div>
							</div>
							<div class="form-group col-5">
								...
								<div class="input-group date">
								<div class="input-group-text"><i class="fas fa-fw fa-table"></i></div>
								<input type="text" class="form-control datepicker" name="sold_date" id="datepicker" placeholder="Sold Date">
								</div>
							</div>
							<div class="form-group col-5">

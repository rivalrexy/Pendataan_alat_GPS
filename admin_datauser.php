		...
		<div id="login" class="container mt-2">
			<div class="container mt-5">
				<div class="card bg-light" style="max-width: 25 rem; margin: 0 auto; float: none;">
					<div class="card-header"><i class="fas fa-table"></i> Data User</div>
					<div class="card-body">
						<a class="btn btn-primary" href="admin_datauser_tambah.php"><i class="fas fa-fw fa-plus"></i>Tambah</a><br></br>
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<tbody>
										...
										include 'koneksi.php';
										$no = 1;
										$data = pg_query($conn,"select * from public.user");
										...
										<tr>
											...
											<td>
												<a class="btn btn-warning" href="admin_datauser_edit.php?id=<?php echo $d['id_user']; ?>"><i class="fas fa-fw fa-edit"></i></a>
												<a class="btn btn-danger" onclick="return konfirmasi()" href="admin_datauser_hapus.php?id=<?php echo $d['id_user']; ?>"><i class="fas fa-fw fa-trash"></i></a>
											</td>
										</tr>
										<?php 
										}

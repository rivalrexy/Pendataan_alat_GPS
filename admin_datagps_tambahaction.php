			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				if($ukuran < 1044070){			
					...
					if($query){
						...
						header("location:admin_datagps_tambah.php?pesan=gagal");
					}
				}else{
					header("location:admin_datagps_tambah.php?pesan=besar");
				}
			}else{
				header("location:admin_datagps_tambah.php?pesan=salah");
			}
	//}
?>
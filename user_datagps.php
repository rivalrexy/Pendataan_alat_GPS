		...
		<div id="login" class="container mt-2">
			<div class="container mt-5">
				<div class="card bg-light" style="max-width: 25 rem; margin: 0 auto; float: none;">
					...
					<div class="card-body">
						<a class="btn btn-primary" href="user_datagps_tambah.php"><i class="fas fa-fw fa-plus"></i>Tambah</a><br></br>
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a class="btn btn-warning" href="user_datagps_edit.php?id=<?php echo $d['id_gps']; ?>"><i class="fas fa-fw fa-edit"></i></a>
												<a class="btn btn-danger" onclick="return konfirmasi()" href="user_datagps_hapus.php?id=<?php echo $d['id_gps']; ?>"><i class="fas fa-fw fa-trash"></i></a>
											</td>
										</tr>
										<?php 
										}
